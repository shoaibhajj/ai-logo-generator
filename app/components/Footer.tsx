          ...
          <ul className="flex gap-5 flex-row  flex-wrap mx-auto justify-center md:my-0  md:justify-end items-center w-full px-5 ">
            {contacts.map((item) => (
              <a
                ...
                key={item.id}
                target="_blank"
                className="flex items-center justify-center w-14  h-14 text-white bg-primary rounded-full transition-colors hover:bg-n-5 "
              >
                <Image
                  src={item.iconUrl}
                  width={20}
            ...
            <a
              ...
              className="flex items-center justify-center w-14  h-14 bg-primary text-white rounded-full transition-colors hover:bg-n-5 "
            >
